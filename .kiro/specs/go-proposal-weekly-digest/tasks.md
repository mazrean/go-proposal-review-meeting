...
- [ ] 6.4 Claude Code Actionによる要約生成ステップ
...
- [ ] 8.5 Parse→Content統合テスト
  - モックデータでParse → Content の検証
  - 10件のproposal変更を処理
  - ※ 8.1, 8.2に依存
  - _Requirements: 1.1, 1.2, 1.3, 1.4, 2.1, 2.2, 2.3_

- [ ] 8.6 Content→Site統合テスト
